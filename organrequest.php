...
session_start();
  ...
  header('location:login.php');
    ...
    $hid = $_SESSION['hid'];
    $sql = "select organrequest.*, receivers.* from organrequest, receivers where hid='$hid' && organrequest.rid=receivers.id";
    $result = mysqli_query($conn, $sql);
?>

<!DOCTYPE html>
<html>
<?php $title="Organbank | Organ Requests"; ?>
...
<body>
	...
	<table class="table table-responsive table-striped rounded mb-5">
		<tr><th colspan="9" class="title">Organ requests</th></tr>
		<tr>
			<th>#</th>
			<th>Name</th>
			<th>Email</th>
