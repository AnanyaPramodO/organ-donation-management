...
session_start();
  ...
  header('location:login.php');
    ...
    $hid = $_SESSION['hid'];
    $sql = "SELECT organdonate.*, receivers.* from organdonate, receivers where hid='$hid' && organdonate.rid=receivers.id";
    $result = mysqli_query($conn, $sql);
?>

<!DOCTYPE html>
<html>
<?php $title="Organbank | Sent Requests"; ?>
