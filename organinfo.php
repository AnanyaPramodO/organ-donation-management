...
<!DOCTYPE html>
<html>
<?php $title="Organbank | Add organ samples"; ?>
    ...
    <div class="container cont">
      ...
      <div class="row justify-content-center">
         ...
         <div class="col-lg-4 col-md-5 col-sm-6 col-xs-7 mb-5">
          <div class="card">
            <div class="card-header title">Add organ group available in your hospital</div>
        <div class="card-body">
...
<?php   if(isset($_SESSION['hid'])){
    $hid=$_SESSION['hid'];
    $sql = "select * from organinfo where hid='$hid'";
    ...
    <div class="col-lg-4 col-md-5 col-sm-6 col-xs-7 mb-5">
          <table class="table table-striped table-responsive">
            ...
            <tr>
              ...
              <!-- <td><a href="file/delete.php?oid=<?php echo $row['oid'];?>" class="btn btn-danger">Delete</a></td> -->
            </tr>
            <?php } ?>
          </table>
      </div>
