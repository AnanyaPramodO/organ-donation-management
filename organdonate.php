...
session_start();
  ...
  header('location:login.php');
    ...
    $rid = $_SESSION['rid'];
    $sql = "SELECT organdonate.*, hospitals.* from organdonate, hospitals where rid='$rid' && organdonate.hid=hospitals.id";
...
<?php $title="Organbank | Organ Donate"; ?>
...
<body>
	...
	<table class="table table-responsive table-striped rounded mb-5">
		<tr><th colspan="9" class="title">Organ Donate</th></tr>
		<tr>
			<th># </th>
			<th>Name</th>
			<th>Email</th>
