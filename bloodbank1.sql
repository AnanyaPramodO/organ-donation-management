...
CREATE TABLE `organdonate` (
  `donoid` int(11) NOT NULL,
  `rid` int(11) NOT NULL,
  `hid` int(11) NOT NULL,
  `og` varchar(11) NOT NULL,
  `status` varchar(100) NOT NULL DEFAULT 'Pending'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `organinfo`
--
...
--
-- Dumping data for table `organinfo`
--

INSERT INTO `organinfo` (`bid`, `hid`, `og`) VALUES
(7, 1, 'heart'),
(8, 1, 'lung'),
(12, 4, 'kidney'),
(13, 4, 'eyes'),
...
CREATE TABLE `receivers` (
  ...
  `rbg` varchar(10) NOT NULL DEFAULT 'Pending',
...
--
-- AUTO_INCREMENT for table `organinfo`
--
ALTER TABLE `organinfo`
...
--
-- Constraints for table `organinfo`
--
ALTER TABLE `organinfo`
  ADD CONSTRAINT `organinfo_ibfk_1` FOREIGN KEY (`hid`) REFERENCES `hospitals` (`id`);
COMMIT;
